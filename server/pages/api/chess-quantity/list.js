    ...
    switch(method){
        ...
        case "POST":
            try {
                ...
                const data = await _models__WEBPACK_IMPORTED_MODULE_1__/* .ChessQuantity.find */ .y3.find(filter, projection);
                res.status(200).json({
                    success: true,
                    data: data
                });
...
var __webpack_exports__ = __webpack_require__.X(0, [2738], () => (__webpack_exec__(5765)));
