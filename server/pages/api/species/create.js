...
const handler = async (req, res)=>{
    ...
    switch(method){
        case "POST":
            try {
                const data = await _models__WEBPACK_IMPORTED_MODULE_1__/* .Species.insertMany */ .Zj.insertMany(body);
                res.status(200).json({
                    success: true,
                    data: data
                });
...
var __webpack_exports__ = __webpack_require__.X(0, [2738], () => (__webpack_exec__(2162)));
