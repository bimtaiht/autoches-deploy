...
const handler = async (req, res)=>{
    ...
    switch(method){
        case "DELETE":
            try {
                const data = await _models__WEBPACK_IMPORTED_MODULE_1__/* .Species.deleteOne */ .Zj.deleteOne({
                    _id
                });
                res.status(200).json({
                    success: true,
...
var __webpack_exports__ = __webpack_require__.X(0, [2738], () => (__webpack_exec__(8337)));
